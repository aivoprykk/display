 ...
 * Size: 24 px
 * Bpp: 1
 * Opts: --bpp 1 --size 24 --font /Users/aivo/Dropbox/gt31/squareline_proj_2_13_01/assets/Oswald-Regular.ttf -o ./ui_font_OswaldRegular24p1.c --format lvgl -r 0x20-0x7f --no-compress --no-prefilter
 ******************************************************************************/
...
#ifndef UI_FONT_OSWALDREGULAR24P1
#define UI_FONT_OSWALDREGULAR24P1 1
#endif

#if UI_FONT_OSWALDREGULAR24P1
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t ui_font_OswaldRegular24p1 = {
#else
lv_font_t ui_font_OswaldRegular24p1 = {
#endif
...
#endif /*#if UI_FONT_OSWALDREGULAR24P1*/
