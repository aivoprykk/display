...
#define _1680_LUT_FULL_REFRESH_0 ((const uint8_t[]) { \
        VSC, \
        GRP_FULL_0(0x01, 0x0a), \
        PHASE_CTRLC, \
        OTHER_0(KEEP_BIT) \
})
#define _1680_LUT_FULL_REFRESH_1 ((const uint8_t[]) { \
        VS1, \
        GRP_FULL_0(0x01, 0x0a), \
        PHASE_CTRLC, \
        OTHER_1(KEEP_BIT) \
})
#define _1680_LUT_FAST_REFRESH_0 ((const uint8_t[]) { \
        VSC, \
        GRP_F0, \
        GRP_F1, \
        GRP_F2, \
...
#define _1680_LUT_FAST_REFRESH_1 ((const uint8_t[]) { \
        VS2, \
        GRP_C(0x08), \
        GRP_C(0x1), \
        GRP_2_11(0x1), \
...
#define _1681_LUT_FULL_REFRESH ((const uint8_t[]) { \
        VSC, \
        GRP_C(0xa), \
...
#define _1681_LUT_FAST_REFRESH ((const uint8_t[]) { \
        VSC, \
        GRP_F0, \
        GRP_F1, \
        GRP_F2, \
...
#define _1681_LUT_FAST_REFRESH_KEEP ((const uint8_t[]) { \
        VSC, \
        GRP_F0, \
        GRP_F1, \
        GRP_F2, \
