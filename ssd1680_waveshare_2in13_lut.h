...
#define SSD1680_WAVESHARE_2IN13_V2_LUT_FULL_REFRESH_O ((uint8_t[]) { \
        ...
        0xA, 0x2, 0x0, 0xA, 0x2, 0x0, SSD1680_WAVESHARE_2IN13_REFRESH_TIME_O, \
...
#define SSD1680_WAVESHARE_2IN13_V2_LUT_FULL_REFRESH ((uint8_t[]) { \
        ...
        0xA, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, \
        /* Group 1  TP[*A] TP[*B] SR[*AB] TP[*C] TP[*D] SR[*CD] RP[*] */ \
        0xA, 0x2, 0x0, 0xA, 0x2, 0x0, SSD1680_WAVESHARE_2IN13_REFRESH_TIME, \
        /* Group 2  TP[*A] TP[*B] SR[*AB] TP[*C] TP[*D] SR[*CD] RP[*] */ \
        0x0a, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, \
        /* Group 3  TP[*A] TP[*B] SR[*AB] TP[*C] TP[*D] SR[*CD] RP[*] */ \
        0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, \
...
#define SSD1680_WAVESHARE_2IN13_V2_LUT_FAST_REFRESH ((uint8_t[]) { \
        /* LUT 0 VS Group 0~11 */ \
...
#define SSD1680_WAVESHARE_2IN13_V2_LUT_FAST_REFRESH_KEEP_O ((uint8_t[]) { \
        /* LUT 0 VS Group 0~11 */ \
        0x80, 0x48, 0x40, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, \
        /* LUT 1 VS Group 0~11 */ \
        0x40, 0x48, 0x80, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, \
...
// goes GRAY and contrast decrease a lot. Use the LUT below to avoid that issue.
// NOTE: The LUT below will have the source output "keep previous output before power off", so the service life may be affected.
#define SSD1680_WAVESHARE_2IN13_V2_LUT_FAST_REFRESH_KEEP ((uint8_t[]) { \
        /* LUT 0 VS Group 0~11 */ \
        0x0, 0x40, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, \
        /* LUT 1 VS Group 0~11 */ \
        0x80, 0x80, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, \
