...
#define LV_MEM_CUSTOM 1
    ...
    #define LV_MEM_SIZE (57U << 8)   // 57 * 256 = 14592 bytes
#else
    ...
    #define LV_MEM_CUSTOM_ALLOC(size)   heap_caps_malloc(size, MALLOC_CAP_INTERNAL | MALLOC_CAP_DMA)
    #define LV_MEM_CUSTOM_FREE    heap_caps_free
    #define LV_MEM_CUSTOM_REALLOC(ptr, size) heap_caps_realloc(ptr, size, MALLOC_CAP_INTERNAL | MALLOC_CAP_DMA)
#endif     /*LV_MEM_CUSTOM*/
 ...
 */
#if defined(CONFIG_DISPLAY_DRIVER_SS168X)
#define LV_LAYER_SIMPLE_BUF_SIZE          (10 * 1024)
#else
...
#if !defined(CONFIG_LCD_IS_EPD) && !defined(LV_ATTRIBUTE_FAST_MEM)
