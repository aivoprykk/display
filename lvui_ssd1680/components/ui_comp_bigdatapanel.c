...
lv_obj_set_x( cui_BigDataPanel, 0 );
lv_obj_set_y( cui_BigDataPanel, 34 );
...
lv_obj_set_style_bg_opa(cui_BigDataPanel, 255, LV_PART_MAIN| LV_STATE_DEFAULT);
...
lv_obj_set_x( cui_InfoLabel, lv_pct(83) );
lv_obj_set_y( cui_InfoLabel, lv_pct(-9) );
