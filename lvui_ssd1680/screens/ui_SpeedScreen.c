...
lv_obj_set_style_text_font(ui_comp_get_child(ui_SpeedMainPanel, UI_COMP_BIGDATAPANEL_DATALABEL), &ui_font_OpenSansBold78p2, LV_PART_MAIN| LV_STATE_DEFAULT);
...
lv_obj_set_style_text_font(ui_comp_get_child(ui_LeftPanel, UI_COMP_SMALLDATAPANEL_DATALABEL), &ui_font_OpenSansBold30p1, LV_PART_MAIN| LV_STATE_DEFAULT);

ui_RightPanel = ui_SmallDataPanel_create(ui_SpeedSecondaryPanel);
lv_obj_set_x( ui_RightPanel, 125 );
lv_obj_set_y( ui_RightPanel, 1 );

lv_obj_set_style_text_font(ui_comp_get_child(ui_RightPanel, UI_COMP_SMALLDATAPANEL_DATALABEL), &ui_font_OpenSansBold30p2, LV_PART_MAIN| LV_STATE_DEFAULT);
